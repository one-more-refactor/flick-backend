...
async fn identity_fields_are_length_bounded() {
    ...
    // Login with oversized email or password returns 401
    let resp = send(
        &app,
        json_request(
            "POST",
    ...
    // Admin login with oversized email or password returns 401
    let resp = send(
        &app,
        json_request(
            "POST",
    ...
    // Lookup with oversized email reports non-existence
    let resp = send(
        &app,
        json_request(
            "POST",
    ...
    // Code verify with oversized email or code returns 400
    let resp = send(
        &app,
        json_request(
            "POST",
