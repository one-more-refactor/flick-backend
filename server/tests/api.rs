...
async fn identity_fields_are_length_bounded() {
    ...
    // lookup with oversized email returns exists: false
    let resp = send(
        &app,
        json_request(
            "POST",
    ...
    // code request with oversized email returns 204
    let resp = send(
        &app,
        json_request(
            "POST",
    ...
    // code verify with oversized code returns 400
    let resp = send(
        &app,
        json_request(
            "POST",
    ...
    // user login with oversized password returns 401
    let resp = send(
        &app,
        json_request(
            "POST",
    ...
    // admin login with oversized password returns 401
    let resp = send(
        &app,
        json_request(
            "POST",
